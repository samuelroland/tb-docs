// This is a modification of this example of lsp-server
// https://github.com/rust-lang/rust-analyzer/blob/master/lib/lsp-server/examples/goto_def.rs
//
// I slightly modified it which add an example LocationLink in the returned vector,
// instead of an empty vector like the source code in the above link.
// I also disabled some eprintln to see only LSP messages.
//
// I also wrote a way to run the scenario described in comments below, see
...
use lsp_types::{Location, OneOf, Position, Range, Uri};
        ...
        match msg {
            Message::Request(req) => {
                ...
                match cast::<GotoDefinition>(req) {
                    ...
                    Err(err @ ExtractError::JsonError { .. }) => panic!("\n{err:?}"),

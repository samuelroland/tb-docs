...
Les enseignant·es de programmation ont maintenant de nouveaux outils à disposition pour rendre leurs cours dynamiques, donner du feedback en live durant des exercices et très rapidement créer de nouveaux exercices dans des fichiers texte. J'espère sincèrement que de nombreux cours à la HEIG-VD et d'autres universités pourront en bénéficier dans le futur. Il reste à les convaincre de la valeur de l'outil, de l'intérêt de la pratique délibérée et qu'ajouter de l'interaction dans leur cours avec PLX peut aider leurs étudiant·es à acquérir des compétences profondes et plus complexes.

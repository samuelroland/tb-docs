...
Durant la correction, l'enseignante va présenter sa solution et demander s'il y a des questions. Certain·es étudiant·es les plus avancé·es poseront peut-être des questions sur l'approche ou une fonction spécifique. Il est cependant rare d'entendre une question du type #quote("Je suis complètement paumé·e, vous pouvez réexpliquer ce que fait cette fonction ?") ou encore #quote("Je ne sais pas ce qui est flou, mais je n'ai vraiment pas compris votre solution."). D'autres qui n'ont pas pu terminer l'exercice ne savent pas si leur début partait dans la bonne direction, même si la solution était bien expliquée.

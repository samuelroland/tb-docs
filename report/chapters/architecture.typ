...
*Note: Le protocole détaillé de synchronisation n'a pas encore été défini.*
...
*Note: ceci est une brouillon, il sera continué les semaines suivantes.*
...
- `see` demande à voir une ou plusieurs ligne en sortie standard.
...
Toutes les propriétés sont optionelles, soit elles ont une valeur par défaut, soit la configuration est implicite.
